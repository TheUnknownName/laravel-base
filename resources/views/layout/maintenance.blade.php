    ...
    <section id="wrapper" class="error-page">
        <div class="error-box">
            <div class="error-body text-center">
                ...
                <h3 class="text-uppercase">This Page is Currently Under Maintenance</h3>
                <p class="text-muted m-t-30 m-b-30">It looks like you're trying to find your way home.</p>
                <a href="{{ route('landing-page-home') }}" class="btn btn-info btn-rounded waves-effect waves-light m-b-40 text-white">Back to Home</a>
            </div>
        </div>
    </section>
    <!-- ============================================================== -->
